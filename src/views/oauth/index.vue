      ...
      <el-form class="dialog-form" ref="form" :model="formData" :rules="rules" label-width="120px">
        ...
        <el-form-item v-if="formData.oauth_type === 'oidc'" label="Issuer" prop="issuer">
          <el-input v-model="formData.issuer"
            :placeholder="`${T('Check your IdP docs, without')} '/.well-known/openid-configuration'`"></el-input>
        </el-form-item>
        <el-form-item v-show="formData.oauth_type === 'oidc'" label="Scopes" prop="scopes">
          <el-input v-model="formData.scopes"
            :placeholder="`${T('Optional, default is')} 'openid,profile,email'`"></el-input>
        </el-form-item>
        ...
        <el-form-item label="ClientSecret" prop="client_secret">
          <el-input v-model="formData.client_secret" :type="formData.id ? 'password' : 'text'"
        ...
        <el-form-item label="PkceEnable" prop="pkce_enable">
          <el-switch v-model="formData.pkce_enable" :active-value="true" :inactive-value="false">
          </el-switch>
        </el-form-item>
