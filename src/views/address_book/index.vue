  ...
  <div class="address-book-container">
    ...
    <el-card class="list-query" shadow="hover">
      <div class="mobile-header" v-if="isMobile">
        ...
        <el-button class="filter-toggle" color="#8B5CF6" @click="showFilters = !showFilters">
          <el-icon v-if="showFilters">
            <Hide />
          </el-icon>
          <el-icon v-else>
            <View />
      ...
      <el-form :inline="!isMobile" label-width="100px"
        ...
        <el-form-item :class="{ 'full-width-button': isMobile }">
          <el-button type="primary" :icon="CirclePlusFilled" @click="toAdd" class="add-button">{{ T('Add')
            }}</el-button>
        </el-form-item>
        <el-form-item class="form-actions">
          <el-button type="danger" :icon="RefreshLeft" @click="clearFilters" class="add-button">{{ T('Clear Filters')
            }}</el-button>
        </el-form-item>
    ...
    <div class="mobile-list-view" v-if="isMobile" v-loading="listRes.loading">
      <el-card class="mobile-item-card" shadow="hover" v-for="row in listRes.list" :key="row.id">
        <div class="card-header">
          <div class="card-title">
            <PlatformIcons :name="platformList.find(p => p.label === row.platform)?.icon" class="platform-icon"
    ...
    <!-- Form Dialog -->
    <el-dialog v-model="formVisible" :width="isMobile ? '95%' : '800px'"
      :title="!formData.row_id ? T('Create') : T('Update')" :fullscreen="isMobile">
      <el-form class="dialog-form" ref="form" :model="formData" :label-width="isMobile ? 'auto' : '120px'"
